...
if ( !function_exists( 'chld_thm_cfg_parent_css' ) ):
    function chld_thm_cfg_parent_css() {
        ...
        wp_enqueue_style( 'bootstrap', trailingslashit( get_stylesheet_directory_uri() ) . '/assets/bootstrap/css/bootstrap.min.css', array() );
        wp_enqueue_style( 'ionicons', trailingslashit( get_stylesheet_directory_uri() ) . '/assets/fonts/ionicons.min.css', array() );
