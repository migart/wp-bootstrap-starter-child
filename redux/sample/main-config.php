<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Opcje', 'redux-framework-demo' ),
        'page_title'           => __( 'Opcje', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                'id'       => 'hire-me-1',
                'type'     => 'text',
                'title'    => __( 'Hire me button 1', 'redux-framework-demo' ),
            ...
            array(
                'id'       => 'hire-me-2',
                'type'     => 'text',
                'title'    => __( 'Hire me button 2', 'redux-framework-demo' ),
                'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
                'desc'     => __( 'Field Description', 'redux-framework-demo' ),
                'default'  => 'Default Text',
            ),
